...
public class QuizFragment extends Fragment
{
    ...
    private List<String> quizCountryList; // countries in current quiz
    private Set<String> typesSet; // world regions in current quiz
                             ...
                             Bundle savedInstanceState)
    {
        ...
        questionNumberTextView.setText(
                getResources().getString(R.string.question, 1, ANIMALS_IN_QUIZ));
    ...
    public void resetQuiz()
    {
        ...
        try
        {
            ...
            for (String types : typesSet)
            {
                ...
                String[] paths = assets.list(types);
        ...
        quizCountryList.clear(); // clear prior list of quiz countries
        ...
        while (animalCounter <= ANIMALS_IN_QUIZ)
        {
            ...
            {
                quizCountryList.add(fileName); // add the file to the list
                ++animalCounter;
            }
        }
    ...
    private void loadNextAnimal()
    {
        ...
        questionNumberTextView.setText(getResources().getString(R.string.question,
                        (correctAnswers + 1), ANIMALS_IN_QUIZ));
        ...
        try
        {
            ...
            InputStream stream =
                    assets.open(type + "/" + nextImage + ".png"); // OJO
        ...
        String animalName = getCountryName(correctAnswer);
